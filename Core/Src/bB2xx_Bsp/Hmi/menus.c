...
void MenuHilightItem(Menu_TypeDef *menu)
{
	...
	DisplayStringAt(menu[SystemVar.selected_menu_item].linex,menu[SystemVar.selected_menu_item].liney,menu[SystemVar.selected_menu_item].text,MENU_NORMAL_COLOR);
	SystemVar.selected_menu_item = SystemVar.next_menu_item;
	DisplayStringAt(menu[SystemVar.selected_menu_item].linex,menu[SystemVar.selected_menu_item].liney,menu[SystemVar.selected_menu_item].text,MENU_HILIGHT_COLOR);
}
...
uint8_t	i=0;
	for(i=0;i<=SystemVar.current_menu[0].items;i++)
		EraseStringAt(SystemVar.current_menu[i].linex,SystemVar.current_menu[i].liney, SystemVar.current_menu[i].text);
	for(i=0;i<=SystemVar.current_menu[0].items;i++)
